...
Reverse-engineer a JS-driven download button:
  1. F12 -> Network -> Fetch/XHR, click the site's download button.
  2. Note Request URL / Method / headers / JSON body / response type.
  3. Configure via env vars (no code changes on Render):
  ...
  API_EXTRA_HEADERS  JSON object merged into request headers
  API_RESPONSE_MODE  "direct" (response IS the pdf) or "jsonurl"
  ID_REGEX           optional regex to pull {id} from the user's URL
"""
